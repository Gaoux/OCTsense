        ...
        <section className='relative grid grid-cols-1 md:grid-cols-2 items-center gap-10 mb-28 z-20'>
          ...
          <div>
            ...
            <p className='text-gray-800 max-w-xl text-lg'>
              Un sistema avanzado de detección en imágenes OCT basado en
              inteligencia artificial. Nuestro objetivo es facilitar la
              detección temprana de patologías oculares, proporcionando
              herramientas para un diagnóstico más preciso y eficiente.
            </p>
          </div>
        ...
        <div className='grid md:grid-cols-2 gap-6 mb-10 relative z-30'>
          ...
          <div className='bg-white rounded-2xl shadow-lg p-6'>
            ...
            <ul className='list-disc list-inside text-gray-700 space-y-2 text-base'>
              ...
              <li>
                Reducción de errores en el diagnóstico gracias al análisis
                asistido por IA
              </li>
              <li>Compatibilidad con múltiples formatos de imagen</li>
              <li className='flex items-center gap-2'>
                <FaLock className='text-blue-600' /> Acceso seguro
              </li>
            </ul>
            <div className='mt-6'>
              <button
