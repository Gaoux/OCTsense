  ...
  return (
    <footer className="bg-very-dark-secondary text-white py-8 px-4 md:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/upload" className="text-gray-300 hover:text-white">{t('navbar.upload')}</Link></li>
            <li><Link to="/analysis" className="text-gray-300 hover:text-white">{t('navbar.analysis')}</Link></li>
            <li><Link to="/report" className="text-gray-300 hover:text-white">{t('navbar.report')}</Link></li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
        <p>© {new Date().getFullYear()} OCTsense - {t('footer.all_rights')}</p>
